...
if __name__ == '__main__':
    ...
    profileData = {}
    nightComputation = input("Compute profile during night events, day events or total (N, D or T)? ")
    ...
    for file in files:
        ...
        if nightComputation == "T":
            ...
            for eventDay in dayEventTimeLine.getEventList():
                ...
                print("Day: ", d)
                #Compute profile data and save them in a text file
                profileData[file][d] = computeProfile(file=file, minT=minT, maxT=maxT, night=d)
                text_file.write( "\n" )
                d+=1
                print("Profile data saved.")
    ...
    if nightComputation == "T":
        ...
        for eventDay in dayEventTimeLine.getEventList():
            ...
            #Plot profile data and save them in a pdf file
            plotProfileDataDuration(profileData=profileData, night=d, valueCat=" TotalLen")
            plotProfileDataDuration(profileData=profileData, night=d, valueCat=" Nb")
            text_file.write( "Statistical analysis: mixed linear models" )
            text_file.write( "{}\n" )
            #Test profile data and save results in a text file
            '''
